...
@section('mainContentHeader')
    <h2 class="text-center" style="  font-decoration:underline; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif" > Check In A Regular Visitor.</h2>
@endsection
                    ...
                    <div class="modal fade" id="checkInVisitor{{$item->id}}" style="display: none;">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            <button type="button" class="btn btn-danger pull-left fa  fa-times-circle" data-dismiss="modal"> Close</button>
                            <button type="button" class="fa fa-check-square btn  btn-success">  Check In Visitor.</button>                            
                          </div>
                        </div>
                        <!-- /.modal-content -->
                      </div>
